...
const Heading = styled.h1`
  ${tw`text-2xl text-center lg:text-left sm:text-3xl lg:text-5xl xl:text-5xl font-black text-gray-100 leading-none`}
  span {
        ...
        <TwoColumn>
          <LeftColumn>
            ...
            <Heading>
              ...
              <SlantedBackground>
                {" "}
                Notre responsabilité est votre protection
              </SlantedBackground>
            </Heading>
