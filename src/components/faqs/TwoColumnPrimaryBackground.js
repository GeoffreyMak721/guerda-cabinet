...
export default ({
  ...
  faqs = [
    {
      question: "Quelles sont les principales responsabilités d'un avocat ?",
      answer:
        "Les avocats, en vertu de l'admission au barreau d'un État, doivent à la fois respecter la loi et protéger les droits de leurs clients. En plus de connaître réellement la loi, en particulier dans son domaine de pratique, un avocat doit être en mesure de communiquer clairement avec ses clients, de travailler avec compétence pour résoudre les besoins de leur client et de faire preuve d'éthique dans l'exécution de leur traitement global d'une affaire.",
    },
    {
      question:
        "Je n'ai pas les moyens de payer un avocat. Offrez-vous une aide juridique gratuite ?",
      answer:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
    },
    {
      question: "Puis-je engager un non-avocat pour un problème juridique ?",
      answer:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
    },
    {
      question: "Quelles sont les conditions pour devenir avocat ?",
      answer:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
    },
    // {
